...
const migrations = [
  "0247_pink_fantastic_four.sql", "0248_conscious_adam_destine.sql",
  "0249_wide_lightspeed.sql", "0250_sleepy_metal_master.sql", "0251_organic_meltdown.sql", "0252_misty_nightshade.sql",
